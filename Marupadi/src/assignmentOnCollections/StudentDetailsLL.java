...
public class StudentDetailsLL {
	public static void main(String[] args)
	{
		StudentDetailsLL object=new StudentDetailsLL();
		LinkedList<StudentPojoArray> studentList=new LinkedList<StudentPojoArray>();
...
private void joinArrayList(LinkedList<StudentPojoArray> studentList)
{
		// TODO Auto-generated method stub
	LinkedList<StudentPojoArray> studentList2=new LinkedList<StudentPojoArray>();
	StudentDetailsLL.getStudentDetails(studentList);
	StudentDetailsLL.getStudentDetails(studentList2);
...
private void checkIsEmpty(LinkedList<StudentPojoArray> studentList) {
		// TODO Auto-generated method stub
...
private void deleteAllDetails(LinkedList<StudentPojoArray> studentList) {
		// TODO Auto-generated method stub
	studentList.clear();
...
private void swapTwoDetails(LinkedList<StudentPojoArray> studentList) {
		// TODO Auto-generated method stub
    Scanner input=new Scanner(System.in);
...
private void extractPortion(LinkedList<StudentPojoArray> studentList) {
		// TODO Auto-generated method stub
	Scanner input=new Scanner(System.in);
	...
	LinkedList<StudentPojoArray> sublist=new LinkedList<StudentPojoArray>();
	sublist=(LinkedList<StudentPojoArray>) studentList.subList(startIndex, endIndex+1);
		this.displayStudentDetails(sublist);
	}



private void displayStudentDetails(LinkedList<StudentPojoArray> studentList) {
		// TODO Auto-generated method stub
...
private void reverseStudentDetails(LinkedList<StudentPojoArray> studentList) {
		// TODO Auto-generated method stub
	LinkedList<StudentPojoArray> reverseList=new LinkedList<>();
...
private static void shuffleArrayList(LinkedList<StudentPojoArray> studentList) {
		// TODO Auto-generated method stub
...
private static void cloningArrayList(LinkedList<StudentPojoArray> studentList) {
		// TODO Auto-generated method stub
...
private static void sortingStudents(LinkedList<StudentPojoArray> studentList) {
		// TODO Auto-generated method stub
...
private static void updateStudentList(LinkedList<StudentPojoArray> studentList) {
		// TODO Auto-generated method stub
	for(StudentPojoArray i:studentList)
	{
	System.out.println("Student Roll number: " + i.getRollNo() + "\nName :" + i.getStudentName() + "\nClass :" + i.getStd() + "\nTamil Mark :" + i.getTamilMark() + "\nEnglish Mark :" + i.getEnglishMark() +"\nMaths Mark :"+i.getMathsMark()+ "\nScience Mark :"+i.getScienceMark()+"\nSocial Mark :"+i.getSocialMark()+"\nTotal Marks :" + i.getTotalMark());
...
private static void searchThroughRollNumber(LinkedList<StudentPojoArray> studentList) {
		// TODO Auto-generated method stub
	Scanner input=new Scanner(System.in);
	...
	private static void getStudentDetails(LinkedList<StudentPojoArray> studentList) {
		// TODO Auto-generated method stub
		int rollNo;
		String studentName;
		char std;
...
System.out.println("Student Roll number: " + i.getRollNo() + "\nName :" + i.getStudentName() + "\nClass :" + i.getStd() + "\nTamil Mark :" + i.getTamilMark() + "\nEnglish Mark :" + i.getEnglishMark() +"\nMaths Mark :"+i.getMathsMark()+ "\nScience Mark :"+i.getScienceMark()+"\nSocial Mark :"+i.getSocialMark()+"\nTotal Marks :" + i.getTotalMark());
	...
	private static void appendDetailsFirstIndex(LinkedList<StudentPojoArray> studentList) {
		// TODO Auto-generated method stub
	...
	private static void retriveUsingIndex(LinkedList<StudentPojoArray> studentList)
	{
		Scanner input=new Scanner(System.in);
	...
	public static void removeDetails(LinkedList<StudentPojoArray> studentList)
	{
		Scanner input=new Scanner(System.in);
